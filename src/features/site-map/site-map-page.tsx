...
const SECTIONS: SiteMapSection[] = [
  {
    ...
    links: [
      ...
      { title: 'Professional Resume', to: '/resume', description: 'Experience, skills, open source' },
    ],
  },
  {
    id: '02',
    ...
    links: [
      ...
      { title: 'Case Studies Hub', to: '/case-studies', description: 'Architecture impact stories' },
      {
